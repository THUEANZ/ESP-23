...
void displayFingering() {
  ...
  display.setFont(u8g_font_7x14B);
  display.drawStr(31, 37, KEY_LETTER[pitch - 49]);  // Show note name from MIDI value
...
void adjustResist() {
  ...
  resistLevel = map(resistLevel, 0, 4095, 0, 10);  // Adjust in 10 levels
...
// Play x note x vlocity for 150 ms durations
